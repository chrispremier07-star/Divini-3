...
| [02](LOT-02-app-shell.md) | App Shell | 01 | 04, 18, 19, 20, 21 | **construit — en attente de validation** |
| [03](LOT-03-data-feedback.md) | Data & Feedback | 01 | 04, 05, 06, 08, 09, 15 | non démarré |
...
**Avancement global de la phase frontend : 12 %** — LOT 00, LOT 01 et LOT 02 construits, inspectés et corrigés. LOT 00 et LOT 01 validés provisoirement ; **LOT 02 en attente de validation explicite**. Aucun écran métier n'existe encore : le premier arrive au LOT 05.
