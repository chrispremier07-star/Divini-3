...
|---|---|---|---|---|
| [00](LOT-00-cadrage-contrat-de-tokens.md) | Cadrage & contrat de tokens | décision artistique (prise) | 01, 22 | non démarré |
| [01](LOT-01-fondations-design-system.md) | Fondations Design System | 00 | 02, 03, 22 | non démarré |
| [02](LOT-02-app-shell.md) | App Shell | 01 | 04, 18, 19, 20, 21 | non démarré |
